...
vfas_index{ 0 },
misc_index{ 0 },
ntc10k3380_Motor{ 3380, 10000, 4700, 4 },
ntc10k3435_Esc{ 3435, 10000, 4700, 7 },
		...
		if (lastRx == START_STOP) {
			...
			if (data == SENSOR_ID_VARIO) {
				...
				case 1: {
					...
					sendPackage(DATA_FRAME, FR_ID_T1, ntc10k3380_Motor.GetTemperature());
				}
						break;
				case 2:
					//sendPackage(DATA_FRAME, FR_ID_T2, mav_telemetry.battery_remaining);
					sendPackage(DATA_FRAME, FR_ID_T2, ntc10k3435_Esc.GetTemperature());
					break;
				case 3:
				...
				case 5:				{
					int32_t gps_status = (mav_telemetry.gps_satellites_visible * 10) + mav_telemetry.gps_fixtype;
					sendPackage(DATA_FRAME, FR_ID_ACCX, gps_status);
				}
									break;
				case 6:				{
					sendPackage(DATA_FRAME, FR_ID_ACCZ, mav_telemetry.battery_remaining);
				}
									break;
				case 7:
